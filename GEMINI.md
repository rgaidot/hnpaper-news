...
*   **`astro.config.mjs`**: The main configuration file for Astro. Configured with **TailwindCSS** and the site URL `https://hnpaper-news-labs.gaidot.net`.
...
*   **Framework:** The site uses **Astro** with **Tailwind CSS**.
