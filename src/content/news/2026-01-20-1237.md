...
## Le FBI fait une descente dans la maison d'un journaliste du Washington Post
...
## Demandez à HN : Comment pouvons-nous résoudre l'épidémie de solitude ? | Hacker News
...
## Evasion en ballon en Allemagne de l'Est
...
## Nous ne pouvons pas avoir de belles choses à cause des grattoirs IA | Hacker News
...
## « ELITE » : l'application Palantir que ICE utilise pour trouver des quartiers à piller
...
## Les influenceurs et les modèles OnlyFans dominent les demandes de visa US O-1
...
## OpenBSD-current fonctionne désormais en tant qu'invité sous Apple Hypervisor
...
## Lorsque le matériel arrive en fin de vie, les entreprises doivent ouvrir le logiciel en source libre
...
## La collecte d'argent m'a foutu en l'air | blog.yakkomajuri.com
...
## Manuel des résultats structurés LLM
...
## Le premier tableau de Michel-Ange, réalisé quand il avait 12 ou 13 ans | Hacker News
...
## Vous avez donc atteint une limite d'âge. Et maintenant ?
...
## Un correctif de 40 lignes a éliminé un écart de performance de 400x
...
## La demande d'électricité aux États-Unis a augmenté en 2025 - l'énergie solaire en a géré 61 % |
...
## Boeing était au courant d'une faille en partie liée au crash de l'avion UPS, selon un rapport du NTSB
...
## Chaque objet GitHub a deux identifiants | Hacker News
...
## Le réseau de comptes X écossais s'éteint au milieu de la panne d'électricité en Iran
...
## Aucune gestion nécessaire : anti-modèles dans les équipes d'ingénierie en démarrage
