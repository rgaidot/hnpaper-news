...
---
## Cowork : Claude Code pour la suite de votre travail | Hacker News
...
## Ne tombez pas dans le battage médiatique anti-IA | Hacker News
...
## Apple se bat pour la capacité TSMC alors que Nvidia occupe le devant de la scène | Hacker News
...
## Pocket TTS : un TTS de haute qualité qui donne une voix à votre processeur | Hacker News
...
## Ozempic change les aliments que les Américains achètent | Hacker News
...
## La date est sortie, Temporal est arrivé | Hacker News
...
## À ceux qui ont licencié ou n'ont pas embauché de rédacteurs techniques à cause de l'IA | Hacker News
