...
## Demandez à HN : développeurs COBOL, comment le codage de l'IA affecte-t-il votre travail ? | Hacker News
...
## Anthropic a désactivé mon compte après le paiement des données médicales d'un patient atteint d'un cancer piégées | Hacker News
