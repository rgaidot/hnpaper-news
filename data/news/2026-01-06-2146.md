...
## Il y a eu des anomalies BGP pendant la panne de courant au Venezuela
...
## Brave a révisé son moteur de blocage de publicité Rust avec FlatBuffers, réduisant ainsi la mémoire de 75 %
...
## RevisionDojo, une startup de YC, mène des campagnes d'astroturfing cibler les enfants ?
...
## Pendant Helene, je voulais juste un site Web en texte brut | Sparkbox
...
## Microsoft Office renommé « Application Microsoft 365 Copilot »
...
## X blâme les utilisateurs pour le CSAM généré par Grok ; aucun correctif annoncé
...
## Toutes les vidéos d'IA sont nocives (2025)
...
## Les résidents de Californie peuvent désormais demander à tous les courtiers en données de supprimer leurs informations personnelles
...
## Jensen : « Nous avons rendu un très mauvais service à notre pays » en délocalisant | Graphique à barres
...
## L'actu sur github.com : Tailsnitch
...
## Le co-fondateur de Sega, David Rosen, est décédé
...
Sous sa direction jusqu'en 1996, Sega est passé d'importateur à concepteur de jeux d'arcade révolutionnaires comme _Periscope_ et _Killer Shark_, et a redéfini l'image des salles d'arcade avec des titres stylisés comme _Outrun_ et _Virtua Fighter_. Rosen a également joué un rôle clé dans l'établissement de Sega of America et le succès mondial de la Mega Drive (Genesis aux États-Unis), rivalisant avec Nintendo par une stratégie marketing audacieuse ciblant les adolescents.
...
## ICE utilise la technologie de reconnaissance faciale pour arrêter rapidement les gens
...
## CSS est nul parce que nous ne prenons pas la peine de l'apprendre (2022)
...
## L'actu sur big.substack.com : Gatekeepers Of Law Inside The Westlaw
...
## Le Pentagone décide de punir le sénateur démocrate pour une « vidéo séditieuse »
...
## Effet de fumée de cigarette à l'aide de shaders
...
## GOG Patrons - Rejoignez les joueurs pour garder les classiques en vie
...
## Pipe Dreams – La vie et à l'époque de Yahoo Pipes (2023)
...
## Novo Nordisk lance la pilule amaigrissante Wegovy aux États-Unis, déclenchant une guerre des prix
...
## Faire face aux abandonwares (2024)
...
- **Article source** : [Dealing with abandonware (2024)](https://blog.hris.to/./dealing-with-abandonware.html)

---

## Rootkit Singularity : contournement SELinux et filtre netlink (ss/conntrack caché)
...
## Construction d'un analyseur statique de style Rust pour C++ avec IA | mpaxos.com
...
## Show HN : Un simulateur pour les ingénieurs en transition de l'IC au management
