...
## Lettre d'une prison de Birmingham [King, Jr.]
...
## Niveaux de tempête géomagnétique G4 (graves) atteints 19 janvier 2026 | Centre de prévision météorologique spatiale de la NOAA/NWS
...
## Zai-org/GLM-4.7-Flash · Visage câlin
...
## Qu'est-ce qui est venu en premier : le CNAME ou l'enregistrement A ?
...
## Calculateur d'intérêts composés gratuit - Calculez la croissance des investissements | Calquio
...
## Article par article, comment les Big Tech ont façonné le recul des droits numériques dans l'UE | Observatoire des entreprises européennes
...
## Wikipedia:WikiProject AI Cleanup - Wikipédia
...
## Pdfwithlove - L'alternative privée à iLovePDF et Smallpdf
...
## Notes sur la nano texture d'Apple
...
## Demandez à HN : développeurs COBOL, comment le codage de l'IA affecte-t-il votre travail ?
...
- **Article source** : [Ask HN: COBOL devs, how are AI coding affecting your work?](item?id=46678550)

---

## Cette bascule Android vous indique quand vous êtes connecté à de fausses tours de téléphonie cellulaire
...
## L'agent code uniquement • Rijnard van Tonder
...
## Les discussions devancent X chez les utilisateurs mobiles quotidiens, selon de nouvelles données | TechCrunch
...
## GitHub - jordanhubbard/nanolang : Un petit langage expérimental conçu pour être ciblé par le codage des LLM
...
## Réparez votre fichier robots.txt ou votre site disparaît de Google
...
## La microstructure du transfert de richesse dans les marchés de prédiction | Jonathan Becker
...
## Apply_chat_template() Est l'interrupteur de sécurité - par Tarun Reddi
...
## Composants Web CSS pour les sites de marketing
...
## Sur l'industrialisation à venir de la génération d'exploits avec les LLM – Blog de Sean Heelan
...
## Le chef du cuivre des West Midlands s'en prend après la suppression de Copilot • Le registre
...
## Anthropic a désactivé mon compte après le paiement des données médicales d'un patient atteint d'un cancer piégées
...
- **Article source** : [Anthropic disabled my account after payment cancer patient/medical data trapped](https://news.ycombinator.com/item?id=46675740)
...
## Les vaches peuvent vraiment utiliser des outils sophistiqués

Une étude récente publiée dans _Current Biology_ bouscule les idées reçues sur l'intelligence animale, notamment celle des vaches, souvent sous-estimée. Une vache nommée Veronika a été observée utilisant habilement un balai pour se gratter, une action qui répond à la définition scientifique de l'utilisation d'outils : la manipulation d'un objet externe pour atteindre un objectif mécanique.
