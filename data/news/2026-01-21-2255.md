...
## Le FBI fait une descente au domicile d'un journaliste du Washington Post | The Guardian

Des agents du FBI ont perquisitionné le domicile de Hannah Natanson, journaliste au _Washington Post_, dans le cadre d'une enquête liée à des documents classifiés. L'action, qualifiée d'"inhabituelle et agressive" par le journal, a conduit à la saisie d'appareils électroniques. Selon le _Post_, Natanson n'est pas considérée comme la cible de l'enquête, qui concerne un sous-traitant gouvernemental accusé de conserver illégalement des documents classifiés. Des groupes de défense de la liberté de la presse ont condamné cette intervention, la qualifiant d'atteinte aux protections constitutionnelles du travail journalistique. L'ancien rédacteur en chef du _Post_, Marty Baron, a exprimé son inquiétude quant à une possible limitation de la liberté de la presse par l'administration. Des interrogations subsistent concernant les motifs de la saisie et les implications sur la protection des sources journalistiques. Plusieurs participants à la discussion soulignent que cette action soulève des questions sur la protection des sources journalistiques et la liberté de la presse. La situation suscite des craintes quant à l'intimidation des sources et à la capacité des journalistes à enquêter sur des sujets sensibles.
...
## Demandez à HN : Partagez votre site Web personnel
...
## Claude Cowork exfiltre les fichiers
...
## Si vous inversez les icônes Apple, cela ressemble à quelqu'un qui devient bon en design
...
## Le raccourcisseur d'URL qui rend vos liens aussi suspects que possible
...
## Les importateurs et les consommateurs américains supportent le coût des tarifs douaniers de 2025 : analyse
...
## Apple se bat pour la capacité de TSMC alors que Nvidia occupe le devant de la scène
...
## Le fonds de pension danois se désengage des bons du Trésor américain
...
## Fuite de ballon en Allemagne de l'Est
...
## L'actu sur electrek.co : Ford F 150 Lightning Outsold Tesla Cybertruck Canceled Not Selling
...
## L'application Palantir aide les raids ICE à Minneapolis | 404media
...
## L'actu sur apps.apple.com : Id6748219622
...
## Apple teste un nouveau design de l'App Store qui brouille la frontière entre les publicités et les résultats
...
## Un monument astronomique de 26 000 ans caché à la vue de tous (2019)
...
## La complexité excessive du bouton radio Shadcn
...
## L'Amérique se dirige lentement vers le désastre du polymarché
...
## Je déteste les actions GitHub avec passion
...
## L'actu sur newsroom.porsche.com : Porsche Deliveries 2025 41484.Html
...
## Qu'est-ce qui est arrivé en premier : le CNAME ou l'enregistrement A ? | Blog Cloudflare
...
## À l'intérieur de l'infrastructure d'Internet Archive
...
## Le Canada réduit de 100 % les tarifs sur les véhicules électriques chinois à 6 %
...
## « ELITE » : l'application Palantir qu'ICE utilise pour trouver des quartiers à attaquer
...
## La Californie est exempte de sécheresse pour la première fois en 25 ans
...
## Prédiction du krach boursier Nvidia | entropicthoughts.com
...
## Demandez à HN : Comment faites-vous RAG localement ?
...
## OpenBSD-current s'exécute désormais en tant qu'invité sous l'hyperviseur Apple
...
## Nova Launcher a ajouté le suivi de Facebook et de Google Ads. Demandez à HN : Avez-vous des preuves que le codage agent fonctionne ?
...
## L'actu sur memoirsandrambles.substack.com : Raising Money Fucked Me Up
...
## Manuel des sorties structurées LLM
...
## Vous avez donc franchi une limite d'âge. Et maintenant ?
...
## Trouvez un pub qui a besoin de vous
...
## 1000 cartes blanches vierges | Wikipédia
...
## La demande d'électricité aux États-Unis a bondi en 2025 – l'énergie solaire en a assuré 61 % |
...
## À ceux qui ont licencié ou n'ont pas embauché des rédacteurs techniques à cause de l'IA
...
## Reticulum, une pile de réseau maillé sécurisée et anonyme
...
## GitHub devrait facturer à tout le monde 1 $ de plus par mois pour financer l'open source
...
## Boîtes Linux via SSH : suspendues lorsqu'elles sont déconnectées
...
## Claude est doué pour assembler des blocs, mais s'effondre toujours lors de leur création
...
## Je quitte Redis pour SolidQueue
