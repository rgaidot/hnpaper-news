...
## Merci HN : vous avez contribué à sauver 33 000 vies
...
## Ring d'Amazon et Nest de Google révèlent la gravité de la surveillance américaine state
...
## Miles Wu, 14 ans, modèle d'origami plié qui peut contenir 10 000 fois son propre poids
...
- **Article source** : [14-year-old Miles Wu folded origami pattern that holds 10k times its own weight](https://www.youtube.com/watch?v=qZuR-772cks)
...
## Extraits de code CSS modernes : Arrêtez d'écrire CSS comme si c'était 2015
...
## J'ai trouvé une ligne Git utile enfouie dans les documents de développeur de la CIA divulgués
...
## Wikipedia a pris la décision de mettre Archive.
...
## Les décisions d'infrastructure que j'approuve ou regrette après 4 ans dans une startup (2024)
...
## Les relais Peer Tailscale sont maintenant généralement disponibles
...
## Le « Robotaxi » de Tesla ajoute 5 accidents supplémentaires à Austin en un mois – 4 fois pires que ceux des humains
...
## LT6502 : Une conception d'ordinateur portable basée sur 6502
...
## Ventes de Tesla en baisse de 55 % au Royaume-Uni, 58 % en Espagne, 59 % en Allemagne, 81 % aux Pays-Bas, 93 % en Norvège
...
## Flashpoint Archive – Terminé 200 000 jeux et animations Web préservés
...
## NewPipe : client YouTube sans vidéos verticales ni flux algorithmique
