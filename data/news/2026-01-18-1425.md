...
## J'ai vidé Windows 11 pour Linux, et vous devriez aussi
...
## Le blog de John Graham-Cumming
...
## La dernière « expérience de navigateur » de Cursor sous-entend un succès sans preuve
...
## L'actu sur electrek.co : Ford F 150 Lightning Outsold Tesla Cybertruck Canceled
...
## Pourquoi certains vêtements rétrécissent au lavage et comment les redresser
...
L'article explore la vie et l'œuvre de Scott Adams, créateur de _Dilbert_, décédé récemment. L'auteur, Scott Alexander, retrace le parcours d'Adams, de ses débuts humoristiques sur le monde de l'entreprise à ses incursions plus controversées dans la politique et le développement personnel. _Dilbert_ est analysé comme une satire de l'expérience des nerds, confrontés à un monde qu'ils perçoivent comme irrationnel. Adams, lui-même, est décrit comme obsédé par l'auto-amélioration et la persuasion, cherchant à maîtriser des techniques pour influencer les autres, notamment l'hypnose.
...
## Nous avons mis Claude Code dans Rollercoaster Tycoon
...
## Nous ne pouvons pas avoir de belles choses à cause des grattoirs de l'IA
...
## Un correctif de 40 lignes a éliminé un écart de performances de 400x
...
## L'actu sur en.wikipedia.org : 1000_Blank_White_Cards
...
## Anthropic a commis une erreur en supprimant les clients tiers
...
## Les leaders du signal préviennent que l'IA agentique est un risque de surveillance non sécurisé et peu fiable
...
## Le robot d'échecs de Delta Air Lines va vous détruire (2024) [vidéo]
...
## La vérité derrière le 2026 Conférence J.P. Morgan Healthcare
...
## Les deux prochaines années du génie logiciel
...
## Chaque objet GitHub a deux identifiants. Anthropic : le développement d'un concurrent de Claude Code utilisant Claude Code est interdit.
