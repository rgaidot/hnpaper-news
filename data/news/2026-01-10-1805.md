...
## Terence Tao : "Récemment, l'application d'outils d'IA à Erdos pr…" - Mathstodon
...
## 53 fois Flock Safety a codé en dur le mot de passe de l'infrastructure de surveillance américaine
...
## La Commission européenne lance un appel à preuves sur l'open source [LWN.net]
...
## Orion pour Linux Statut | Kagi's Docs
...
## Des scientifiques découvrent une thérapie rivale avec l'exercice pour la dépression | ScienceDaily
...
## Service de bus Londres-Calcutta - Wikipédia
...
## Qu'est-il arrivé à WebAssembly
...
## Comment Markdown a conquis le monde - Anil Dash
...
## Dwitter - démos javascript en 140 caractères
...
## Pourquoi j'ai quitté iNaturalist
...
## RTX 5090 + Raspberry Pi : peut-il jouer ? | Blog de Scott
...
## SendGrid ne vous envoie pas d'e-mails à propos d'ICE ou de BLM. C'est une attaque de phishing.
...
## Une vidéo filmée par l'agent de l'ICE qui a tiré sur une femme de Minneapolis apparaît
...
## The NO FAKES Act has a "Fingerprinting" Trap that kills Open Source. We need to lobby for a Safe Harbor. : LocalLLaMA
...
## Commencez vos réunions à 5 minutes – Vallified
...
## MCP est une mode | Blog de Tom Bedor
...
## Afficher HN : fichiers Markdown exécutables avec des tuyaux Unix
...
- **Article source** : [Show HN: Executable Markdown files with Unix pipes](item?id=46549444)

---

## Surveillance Watch : Ils savent qui vous êtes
...
## La dernière version bêta de SteamOS inclut désormais le pilote de noyau NTSYNC - Phoronix
...
## Comment les pirates se battent contre ICE | Electronic Frontier Foundation
...
## Grok désactive le générateur d'images pour la plupart des utilisateurs après le tollé suscité par les images sexualisées de l'IA | Grok IA | The Guardian
...
## L'Opéra national de Washington quitte le Kennedy Center - The New York Times
...
## Tumblr supprimé de l'App Store d'Apple à cause d'images abusives
...
## La logistique est en train de mourir ; ou - Mec, où est mon courrier ? - Lagomorph
...
## GitHub - Hiepler/EuConform : outil de conformité à la loi européenne sur l'IA - Classification des risques et tests de biais
...
## NetBlocks : "⚠️ Mise à jour : cela fait maintenant 24 heures que l'#Iran m'a…" - Mastodon
