...
date: 2026-01-18T17:25:05.326Z
author: HNPaper Bot
tags: ["economie", "ia", "materiel", "programmation", "securite", "societe", "jeux"]
---

## Cowork : Claude Code pour la suite de votre travail
...
## Apple choisit Gemini pour alimenter Siri
...
## La musique générée par l'IA interdite de Bandcamp
...
## Le FBI fait une descente au domicile d'un journaliste du Washington Post

Le FBI a perquisitionné le domicile de Hannah Natanson, journaliste au _Washington Post_, dans le cadre d'une enquête liée à des documents classifiés, un événement qualifié d'« inhabituel et agressif » par le journal. L'opération visait une enquête sur un contractant gouvernemental accusé de détention illégale de documents secrets. Les agents ont saisi des appareils électroniques, dont le téléphone et deux ordinateurs portables de la journaliste. Le _Washington Post_ affirme que Natanson n'est pas considérée comme cible de l'enquête, qui porterait sur Aurelio Perez-Lugones, un administrateur système.
...
## Claude Cowork exfiltre des fichiers
...
## J'ai largué Windows 11 pour Linux, et vous devriez aussi
...
## Apple se bat pour la capacité TSMC alors que Nvidia occupe le devant de la scène
...
## Les disquettes s'avèrent être la meilleure télécommande de télévision pour les enfants | blog.smartere
...
## L'actu sur cursor.com : Scaling Agents
...
## Évasion en ballon en Allemagne de l'Est
...
## Si vous inversez les icônes Apple, on dirait que quelqu'un devient bon en design
...
## L'application Palantir aide les raids ICE à Minneapolis
...
## Pocket TTS : un TTS de haute qualité qui donne une voix à votre processeur
...
## Briar maintient l'Iran connecté via Bluetooth et Wi-Fi lorsque l'Internet devient sombre
...
## L'actu sur theconversation.com : Why Do Some Clothes Shrink In The Wash A Textile Scientist Explains How To Unshrink Them 259388
...
## SparkFun abandonne officiellement AdaFruit en raison d'une violation du CoC
...
## Les certificats de 6 jours et d'adresse IP sont généralement disponibles | Chiffrons
...
## Pourquoi nous avons essayé de remplacer les développeurs chaque décennie depuis 1969
...
## Ozempic change les aliments que les Américains achètent

L'étude publiée dans le _Journal of Marketing Research_ examine l'impact des médicaments comme Ozempic et Wegovy, initialement conçus pour le diabète, sur les habitudes alimentaires des Américains. Les résultats indiquent une réduction significative des dépenses alimentaires des ménages utilisateurs de ces médicaments. Les ménages réduisent leurs dépenses en épicerie de 5,3 % en moyenne dans les six mois suivant le début du traitement. La baisse est plus prononcée pour les ménages à revenus plus élevés, dépassant 8 %. Les dépenses dans les restaurants à service limité, tels que les fast-foods et les cafés, diminuent également d'environ 8 %.
...
## Nous mettons Claude Code dans Rollercoaster Tycoon
...
## Nous ne pouvons pas avoir de belles choses à cause des scrapers de l'IA
...
## Dans l'infrastructure d'Internet Archive
...
## Le Canada réduit les tarifs douaniers de 100 % sur les véhicules électriques chinois à 6 % | Electrek
...
## « ELITE » : l'application Palantir que ICE utilise pour trouver des quartiers à attaquer
...
## Les influenceurs et les modèles OnlyFans dominent les demandes de visa américain O-1 | The Guardian
...
## Anthropic investit 1,5 million de dollars dans la Python Software Foundation
...
## Lorsque le matériel arrive en fin de vie, les entreprises doivent ouvrir les logiciels en source libre
...
## L'actu sur buckscountybeacon.com : Opinion Local Journalism Is How Democracy Shows Up Close To Home
...
## L'actu sur questdb.io : 40 Line Fix Eliminated 400X Performance Gap
...
## Déclaration du président de la Réserve fédérale, Jerome F. Powell [vidéo]
...
## Vous avez donc franchi une limite d'âge. Et maintenant ? | EFF
...
## À ceux qui ont licencié ou n'ont pas embauché de rédacteurs techniques à cause de l'IA
...
## La demande d'électricité aux États-Unis a augmenté en 2025 – l'énergie solaire en a traité 61 % |
...
## Le robot d'échecs de Delta Air Lines vous détruira (2024) [vidéo]
...
## La vérité derrière la conférence J.P. Morgan Healthcare 2026
...
## Les deux prochaines années de génie logiciel
...
## Anthropic : Développer un concurrent de Claude Code utilisant Claude Code est interdit |
