...
date: 2026-01-15T11:03:49.945Z
author: HNPaper Bot
tags: ["economie", "ia", "materiel", "programmation", "securite", "societe", "opensource"]
---

## Bose rend open source ses enceintes intelligentes de cinéma maison SoundTouch avant leur fin de vie
...
## Apple choisit Gemini pour alimenter Siri | CNBC
...
## J'ai abandonné Windows 11 pour Linux, et vous devriez aussi
...
## Comment coder le code Claude en 200 lignes de code
...
## J'ai remplacé Windows par Linux et tout va bien
...
## Recherche et correction de la plus grande fuite de mémoire de Ghostty
...
## « Le problème Erdos #728 a été résolu de manière plus ou moins autonome par l'IA » | mathstodon.xyz
...
## Montrez HN : J'ai créé un jeu de mémoire pour vous apprendre à jouer du piano à l'oreille
...
## Le Ford F-150 Lightning a dépassé les ventes du Cybertruck et a ensuite été annulé en raison de mauvaises ventes
...
## L'Iran entre dans la panne d'IPv6
...
## Kagi lance la version alpha d'Orion pour Linux
...
L'étude publiée dans le _Journal of Marketing Research_ révèle un impact significatif des médicaments GLP-1 (Ozempic, Wegovy) sur les habitudes alimentaires des Américains. En analysant les données de transactions de dizaines de milliers de foyers, la recherche montre une baisse notable des dépenses alimentaires, tant en supermarché qu'au restaurant, dans les six mois suivant le début du traitement.
...
## La date est dépassée, Temporal est arrivé
...
## Les assistants de codage IA empirent ?
...
## Open Chaos : un projet open source en évolution automatique
...
## Les influenceurs et les modèles OnlyFans dominent les États-Unis. Demandes de visa O-1
...
## Examinons de plus près une anomalie BGP au Venezuela
